        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/tecxzo/?viewAsMember=true" className="text-gray-400 hover:text-blue-400 transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/tecxzo/" className="text-gray-400 hover:text-blue-400 transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://x.com/tecxzo" className="text-gray-400 hover:text-blue-400 transition-colors">
